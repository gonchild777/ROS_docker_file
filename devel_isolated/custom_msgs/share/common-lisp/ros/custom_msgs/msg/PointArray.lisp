...
(cl:defclass <PointArray> (roslisp-msg-protocol:ros-message)
  ((points
    :reader points
    :initarg :points
    :type (cl:vector custom_msgs-msg:Point)
   :initform (cl:make-array 0 :element-type 'custom_msgs-msg:Point :initial-element (cl:make-instance 'custom_msgs-msg:Point))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PointArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_msgs-msg:<PointArray> is deprecated: use custom_msgs-msg:PointArray instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PointArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'points)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'custom_msgs-msg:Point))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PointArray>)))
  ...
  (cl:format cl:nil "Point[] points~%~%================================================================================~%MSG: custom_msgs/Point~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PointArray)))
  "Returns full string definition for message of type 'PointArray"
  (cl:format cl:nil "Point[] points~%~%================================================================================~%MSG: custom_msgs/Point~%float64 x~%float64 y~%float64 z~%~%"))
