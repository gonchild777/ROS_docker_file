...
if("TRUE" STREQUAL "TRUE")
  set(industrial_trajectory_filters_SOURCE_PREFIX /home/ROS/workspace/src/industrial_core/industrial_trajectory_filters)
  set(industrial_trajectory_filters_DEVEL_PREFIX /home/ROS/workspace/devel)
  ...
  set(industrial_trajectory_filters_INSTALL_PREFIX /home/ROS/workspace/install)
...
if(NOT "/home/ROS/workspace/src/industrial_core/industrial_trajectory_filters/include;/usr/share/orocos_kdl/cmake/../../../include;/usr/include/eigen3 " STREQUAL " ")
  set(industrial_trajectory_filters_INCLUDE_DIRS "")
  set(_include_dirs "/home/ROS/workspace/src/industrial_core/industrial_trajectory_filters/include;/usr/share/orocos_kdl/cmake/../../../include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'industrial_trajectory_filters' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ROS/workspace/src/industrial_core/industrial_trajectory_filters/${idir}'.  ${_report}")
    endif()
    _list_append_unique(industrial_trajectory_filters_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "industrial_trajectory_filters;orocos-kdl")
